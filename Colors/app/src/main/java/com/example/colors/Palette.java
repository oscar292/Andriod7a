    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.iteOpaque :
                ...
                vGreen.setProgress(0);
                vBlue.setProgress(0);
                vAlpha.setProgress(225);


                break;

            case R.id.iteBlack :
                vAlpha.setProgress(230);
            ...
            case R.id.iteCyan :
                ...
                vRed.setProgress(0);
                vGreen.setProgress(240);
                vBlue.setProgress(230);
                vAlpha.setProgress(100);
            ...
            case R.id.iteYellow :
                ...
                vRed.setProgress(255);
                vGreen.setProgress(235);
                vBlue.setProgress(0);
                vAlpha.setProgress(140);
                break;
